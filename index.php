...
<?php 
  ...
  if(isset($_POST["submit"]))
  {
    ...
    {
      $addQuery = "INSERT INTO FEEDBACK (name,email,body) VALUES ('$name','$email','$body')";
...
<img src="/feedback-app/img/logo.png" class="w-25 mb-3" alt="" />
        <h2>Feedback</h2>
        <p class="lead text-center">Leave feedback for ZAX Technologies</p>
